...
| Property             | Attribute              | Description                                                                                                                                                                       | Type                                                                                          | Default     |
| -------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------- |
| `activeTab`          | `active-tab`           | The actual active tab, and tab-button                                                                                                                                             | `string`                                                                                      | `undefined` |
...
| `position`           | `position`             |                                                                                                                                                                                   | `"bottom" \| "left-rotated" \| "left-stacked" \| "right-rotated" \| "right-stacked" \| "top"` | `"top"`     |
| `reduced`            | `reduced`              | The presence of this attribute will make buttons and tabs reduced, meaning that the font size and padding, will be smaller. Also, the icons in the buttons will not be displayed. | `boolean`                                                                                     | `false`     |
