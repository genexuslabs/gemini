...
</gxg-columns></gxg-stack><div style="text-align:center"><p class="note">Note: <em>gxg-column</em> component does not has any inherent background-color or border color styles.<br>The ones applied on this example are only for the purpose of viusally understanding how the columns system works.</p><gxg-button onClick="(function(){
