...
| `iconColor`     | `icon-color`     | The icon color                                                                                                         | `"alwaysblack" \| "auto" \| "disabled" \| "error" \| "indeterminate" \| "mercury" \| "negative" \| "onbackground" \| "ondisabled" \| "primary-active" \| "primary-enabled" \| "primary-hover" \| "success" \| "warning"` | `"mercury"` |
| `maxWidth`      | `max-width`      | The component max. width                                                                                               | `string`                                                                                                                                                                                                                 | `"100%"`    |
| `minHeight`     | `min-height`     | The component min. height                                                                                              | `string`                                                                                                                                                                                                                 | `"auto"`    |
