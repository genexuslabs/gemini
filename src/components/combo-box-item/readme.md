...
| `itemSelected`   | This event is triggered when the user clicks on an item. event.detail contains the item index, item value, and item icon.                                                                                 | `CustomEvent<{ el: HTMLGxgComboBoxItemElement; index: number; value: any; }>` |
