...
| `exportparts`          | `exportparts`            | The exportparts definition                                                                                                               | `string`                                                                                                                                                                                           | `undefined`           |
...
| `part`                 | `part`                   | The prefix used for auto-generation of exportparts. (exportparts = partPrefix + part-name)                                               | `string`                                                                                                                                                                                           | `undefined`           |
