...
| `negative`             | `negative`               | The presence of this attribute turns the icon white                                                                                      | `boolean`                                                                                                                                                                                          | `false`               |
| `selected`             | `selected`               | This property is for the button-container component                                                                                      | `boolean`                                                                                                                                                                                          | `false`               |
| `small`                | `small`                  | The presence of this attribute makes the button small (only for buttons that include an icon)                                            | `boolean`                                                                                                                                                                                          | `false`               |
