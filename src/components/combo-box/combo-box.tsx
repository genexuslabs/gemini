...
export class GxgComboBox implements FormComponent {
  ...
  @Method()
  async async async async async async async async async async async open() {
   ...
   */
  @Method()
  async async async async async async async async async async async close() {
    this.listIsOpen = false;
  }

  @Method()
  async async async async async async async async async async async getValueByIndex(index: number): Promise<string> {
  ...
  @Method()
  async async async async async async async async async async async setValueByIndex(index: number): Promise<boolean> {
    const enabledItems = this.getEnabledItems();
    const foundItem = enabledItems.filter((item) => item.index === index)[0];
