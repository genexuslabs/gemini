...
| `icon`         | `icon`          | Input icon possible values: the same as the values for the icon component | `"none" \| "add" \| "arrow-down" \| "arrow-left" \| "arrow-right" \| "arrow-up" \| "chevron-down" \| "chevron-left" \| "chevron-right" \| "chevron-up" \| "close" \| "color-picker" \| "deleted" \| "drag" \| "duplicate" \| "edit-wand" \| "edit" \| "empty" \| "error" \| "level-down" \| "level-up" \| "more-info" \| "search" \| "settings" \| "show-more" \| "success" \| "warning"` | `null`      |
